...
volatile uint8_t  MEGA2560RCInput::_num_channels = 0;
volatile bool  MEGA2560RCInput::_new_input = false;

/* private callback for input capture ISR */
void MEGA2560RCInput::_timer4_capt_cb(void) {
...
void MEGA2560RCInput::init(void* _isrregistry) {
    ...
    /* OCR4B and OCR4C will be used by RCOutput_MEGA2560. Init to 0xFFFF to prevent premature PWM output */
    OCR4B  = 0xFFFF;
    OCR4C  = 0xFFFF;
...
uint8_t MEGA2560RCInput::num_channels() { return _num_channels; }
